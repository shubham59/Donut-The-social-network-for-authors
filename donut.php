          ...
          <div class="row">
              <div class="col-md-12">
                <div class="inner cover">
                  <h1 class="cover-heading">Donut : Bringing Literature to Lives</h1>
                ...
                <div class="col-md-12"><div class="inner cover">
                      <h1 class="cover-heading">Donut's 1st Release </h1>
                      <p class="lead">No, Not Again <span class="badge">IIT dreams to Downfall</span><br> -By Shubham Tripathi</p>
